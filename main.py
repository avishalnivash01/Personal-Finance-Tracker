...
class CSV:
    ...
    @classmethod
    def initialize_csv(cls):  # ✅ Fixed typo
        try:
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        return filtered_df  # ✅ Return filtered data for plotting
...
def plot_transactions(df):
    ...
    plt.plot(expense_df.index, expense_df["amount"], label="Expense", color="r")  # ✅ Fixed label
    plt.xlabel("Date")
    plt.ylabel("Amount")
...
def main():
    while True:
        ...
        if choice == "1":
            ...
            end_date = get_date("Enter the end date (dd-mm-yyyy):")  # ✅ Fixed prompt
            df = CSV.get_transactions(start_date, end_date)
            if not df.empty and input("Do you want to see your plot? (y/n): ").lower() == "y":
